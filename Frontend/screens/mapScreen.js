    ...
    return (
      <>
        ...
        <SafeAreaView style={styles.Container}>
          ...
          injectedJavaScript={`
          var curMarker = L.marker([${curLocLat}, ${curLocLong}]).bindTooltip("Origin", {permanent: true, direction: 'right'});
          curMarker.addTo(mymap);
          var desMarker = L.marker([${desLocLat}, ${desLocLong}]).bindTooltip("Destination", {permanent: true, direction: 'right'});;
